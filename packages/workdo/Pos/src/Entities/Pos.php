...
class Pos extends Model
{
    ...
    protected $fillable = [
        ...
        'net_amount',
        'delivery_time',
        'raw_material_purchase_category_id',
        'raw_material_item_category_id',
        'raw_material_usage_quantity',
    ];
    ...
    {
        $barcodeFormat = !empty(company_setting('barcode_type')) ? company_setting('barcode_type') : 'code128';
        return $barcodeFormat;
    }

    public static function nextPosId()
    {
