...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pos-assets/css/site.css') }}" id="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('pos-assets/css/custom.css') }}" id="main-style-link">
    <style>
...
<body class="{{ isset($themeColor) ? $themeColor : 'theme-1' }}">
    ...
    <script src="{{ asset('pos-assets/js/custom.js') }}"></script>
