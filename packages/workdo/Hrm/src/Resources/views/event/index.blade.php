...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ asset('Hrm/src/Resources/assets/css/main.css') }}">
    <link rel="stylesheet" href="{{ asset('Hrm/src/Resources/assets/css/custom.css') }}">
@endpush
@section('page-action')
    <div class="d-flex">
        @stack('addButtonHook')
...
@push('scripts')
    <script src="{{ asset('Hrm/src/Resources/assets/js/main.min.js') }}"></script>
