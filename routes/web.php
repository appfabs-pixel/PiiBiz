...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('production/store', [\App\Http\Controllers\ProductionController::class, 'storeProduction'])->name('production.store');
    Route::get('sales', [\App\Http\Controllers\SalesController::class, 'index'])->name('sales.index');
    Route::post('sales/upload', [\App\Http\Controllers\SalesController::class, 'upload'])->name('sales.upload');
...
Route::get('clear-sidebar-cache', function() {
    sideMenuCacheForget();
    return 'Sidebar cache cleared. Please refresh the dashboard.';
});
